 ...
 */
@Configuration
@PropertySource(value = {"classpath:db.properties", "classpath:security.properties"})
@ComponentScan( basePackages ={ "com.hhh.service", "com.hhh.dao"}, 
					excludeFilters = @ComponentScan.Filter(value = Controller.class, type = FilterType.ANNOTATION)) 
@EnableJpaRepositories(basePackages = { "com.hhh.dao" },
...
//	logger.info("Retrieve data source : " + dataSource.getConnection().createStatement());
		...
		lcemf.setPackagesToScan("com.hhh.dao.entity");
