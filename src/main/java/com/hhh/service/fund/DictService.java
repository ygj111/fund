...
import com.hhh.dao.fund.DictRepository;
import com.hhh.web.model.fund.DictBean;
...
public class DictService {
	...
	public List<DictBean> getAllDic(int pageNum, int pageSize) {
		...
		Page<SysDict> dics = dicRep.findAll(pageReq);
	...
	public int getDicPageCount(int pageSize) {
		logger.info("count=" + dicRep.count() );
		return (int)Math.ceil( (double)dicRep.count() / pageSize);
	}
	...
	public DictBean findDictWithCode(String code) {
		SysDict dict = dicRep.findByCode(code);
